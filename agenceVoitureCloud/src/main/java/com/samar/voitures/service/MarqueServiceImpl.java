...
import com.samar.voitures.dto.MarqueDTO;
...
public class MarqueServiceImpl implements MarqueService {
	...
	@Override
	public MarqueDTO convertEntityToDto(Marque marque) {
		MarqueDTO marqueDTO = new MarqueDTO();
		marqueDTO.setIdMarque(marque.getIdMarque());
		marqueDTO.setNomMarque(marque.getNomMarque());
		marqueDTO.setDescriptionMarque(marque.getDescriptionMarque());
